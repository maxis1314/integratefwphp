...
class Graph {
    ...
    public $doframe=true,$frame_color='white', $frame_weight=1; // Frame around graph
    ...
    function __construct($aWidth=300,$aHeight=200,$aCachedName='',$aTimeout=0,$aInline=true) {
        ...
        $this->title->SetFont(FF_SIMSUN,FS_BOLD);
...
class SuperScriptText extends Text {
    ...
    function Stroke($aImg,$ax=-1,$ay=-1) {
        ...
        if( $this->sfont_family == '' ) {
            if( $this->font_family <= FF_SIMSUN ) {
                if( $this->font_family == FF_SIMSUN ) {
                    $sff = FF_SIMSUN;
                }
                elseif( $this->font_family == FF_SIMSUN ) {
...
class AxisPrototype {
    ...
    public $title=null;
    public $font_family=FF_SIMSUN,$font_style=FS_NORMAL,$font_size=12,$label_angle=0;
    public $tick_step=1;
    public $pos = false;
...
class DisplayValue {
    ...
    private $ff=FF_SIMSUN,$fs=FS_NORMAL,$fsize=10;
