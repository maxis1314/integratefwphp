...
$rmapi = new RMAPI('aY_SS1P80ww6ouPCQaxqIagBIMiwLQxT6uyBqe8b0omqtdq3W8UOGSaVfAAhJDg2');
...
$request = array (
	"FromAddress"   => "admin@mim1314.com",
	"Recipients"    =>  array(
                            array("Address" => "maxis1314@aol.com"), 
                        ),
	...
	"Headers"       => array( 
		                ...
		                "From" => "FromName <admin@mim1314.com>", 
                        "X-Company" => "ReachMail"
                        ),
