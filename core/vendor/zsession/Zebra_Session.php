 ...
 *  @version    2.0.2 (last revision: October 24, 2011)
...
class Zebra_Session
{
     ...
     *                                          Default is <i>60</i>
     *
     *  @param  resource    $link               A MySQL link identifier.
     *
     *                                          If the link identifier is not specified, the last link opened by
     *                                          mysql_connect() is assumed.
     *
     *                                          On some environments (particularly on shared hostings) the "last link
     *                                          opened by mysql_connect" may not be available at the time of instantiation
     *                                          of the Zebra_Session library. For these cases, supplying the MySQL link
     *                                          identifier to the constructor method will fix things.
     *
     *  @return void
     */
    function Zebra_Session($session_lifetime = '', $gc_probability = '', $gc_divisor = '', $security_code = 'sEcUr1tY_c0dE', $table_name = 'session_data', $lock_timeout = 60, $link = '')
    {
    ...
    function gc($maxlifetime)
    {
        ...
        $result = $this->_mysql_query('
            ...
            DELETE FROM
                ' . $this->table_name . '
            WHERE
                session_expire < "' . $this->_mysql_real_escape_string(time() - $maxlifetime) . '"
