...
class T_Session extends DB_Table
{
    public $db             = NULL;
    protected $session_table  = '';

    protected $max_life_time  = 36000; // SESSION 过期时间

    protected $session_name   = '';
    protected $session_id     = '';

    protected $session_expiry = '';
    protected $session_md5    = '';

    protected $session_cookie_path   = '/';
    protected $session_cookie_domain = '';
    protected $session_cookie_secure = false;
    ...
    {
        $this->db = DB_Config::getDbLink();
        $this->cls_session($session_table, $session_data_table, $session_name, $session_id);
    }

    function cls_session($session_table, $session_data_table, $session_name = 'ECS_ID', $session_id = '')
    {
        ...
        else
        {
            ...
            setcookie($this->session_name, $this->session_id . $this->gen_session_key($this->session_id), time()+10*3600, $this->session_cookie_path, $this->session_cookie_domain, $this->session_cookie_secure);
        }
    ...
    function update_session()
    {
        ...
        //echo 'UPDATE ' . $this->session_table . " SET expiry = '" . $this->_time . "', ip = '" . $this->_ip . "', userid = '" . $userid . "', adminid = '" . $adminid . "', user_name='" . $user_name . "', user_rank='" . $user_rank . "', discount='" . $discount . "', email='" . $email . "', data = '$data' WHERE sesskey = '" . $this->session_id . "' LIMIT 1";
