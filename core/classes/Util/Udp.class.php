...
{
    static $stat_server = "115.28.24.177";
    /**
    ...
    {
        $report_address = $report_address ? $report_address : 'udp://'.StatisticClient::$stat_server.':55656';
...
class Util_Udp{
    static function udp_report($module,$interface,$success,$code,$msg){
